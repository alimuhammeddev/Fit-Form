...
const Hero3 = () => {
  return (
    <section>
      <div>
        <h1 className="text-center text-[40px] font-semibold text-[#1b1b1b]">
          Browse Plans
        </h1>
        <h2 className="bg-[#0071FE] text-[#ffffff] text-[16px] gap-2 flex items-center p-3 w-fit justify-center mx-auto mt-3">
      ...
      <div className=" flex flex-wrap justify-center items-center gap-96 mt-10">
        <div className="flex items-center gap-3">
          ...
          <h2 className="flex items-center border w-fit p-3 border-[#396BAA] gap-3 text-[16px] text-[#1B1B1B]">
      ...
      <div className="grid lg:grid-cols-3 pb-10 mt-16 lg:pl-10 lg:gap-0 gap-5">
        <div className="bg-[#FFFFFF] border border-[#5FA5FD80] w-[374px] h-[517px] p-10 hover:shadow-2xl cursor-pointer transition ease-out duration-500">
          ...
          <h2 className="text-[32px] text-[#1B1B1B] font-semibold text-center">
            ₦20,000
          </h2>
          <p className="border border-[#D0D5DD] w-[276px] mt-6 mx-auto"></p>
          <div className="mt-8 space-y-4">
            <h1 className="text-[#1B1B1B] text-[19px] flex items-center gap-2">
          ...
          <div className="flex mx-auto justify-center mt-8">
            <button className="w-[220px] h-[67px] text-[#ffffff] font-semibold bg-[#1B1B1B]">
              Choose Plan
            </button>
          </div>
        </div>
        ...
        <div className="bg-[#FFFFFF] border border-[#396BAA1A] w-[374px] h-[570px] shadow-2xl cursor-pointer transition ease-out duration-500">
          ...
          <div className="p-10">
            ...
            <div className="mt-8 space-y-4">
              ...
              <h1 className="text-[#1B1B1B] text-[20px] flex items-center gap-2">
            ...
            <div className="flex mx-auto justify-center mt-5">
              <button className="w-[220px] h-[67px] text-[#1b1b1b] font-semibold bg-[#FFA500]">
                Choose Plan
              </button>
            </div>
          </div>
