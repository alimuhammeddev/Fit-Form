    ...
    <section style={{
        ...
        <div className='mx-auto relative md:mt-36 mt-32 pb-10 max-w-screen-xl'>
            ...
            <div className="absolute inset-y-0 left-0 flex items-center justify-start">
                ...
                <h1 className='lg:text-[56px] text-[20px] font-semibold text-[#FFFFFF]'>Elevate Your Fitness <br className='lg:block hidden'/> Journey</h1>
                ...
                <div className='lg:mt-5 mt-1'>
                    <button className='text-[#1B1B1B] lg:text-[20px] lg:p-0 p-1 font-medium rounded-sm lg:w-[220px] lg:h-[67px] bg-[#FFA500]'>Get Started</button>
                </div>
