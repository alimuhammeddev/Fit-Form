    ...
    <section style={{
        ...
        <div className='mx-auto relative md:mt-36 mt-32 pb-10 max-w-screen-xl'>
            ...
            <div className="absolute inset-y-0 left-0 flex items-center justify-start">
                <div className="text-left  lg:ml-10 px-5">
                ...
                <div className='mt-5'>
                    <button className='text-[#1B1B1B] text-[20px] font-medium rounded-sm lg:w-[220px] lg:h-[67px] bg-[#FFA500]'>Get Started</button>
                </div>

                <div className='flex items-center md:mt-36 gap-5'>
                    <h1 className='text-[#ffffff] lg:text-[20px] text-[12px] font-medium'>SOCIALS</h1>
                    <h3 className='w-[60px] border-[3px] border-[#FFC354]'></h3>
