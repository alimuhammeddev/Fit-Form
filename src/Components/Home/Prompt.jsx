...
const Prompt = () => {
  return (
    <section>
        ...
        <img src={manbuilding} alt="" className="w-fit lg:block hidden" />
        <div className="lg:absolute lg:top-0 lg:left-0 lg:p-7 p-3 bg-[#1B1B1B40] backdrop-blur-md lg:mt-12 mt-1 lg:ml-10">
            <div>
