...
const Who = () => {
    ...
    return (
      <section>
        <div>
          <h1 style={headingStyle} className='text-[#396BAA] md:text-[80px]'>Who We Are</h1>
          <div className='grid lg:grid-cols-2 mx-auto justify-center gap-10'>

            <div className='relative'>
                <img src={smilingfriends} alt="" />
                <div className="absolute bottom-0 lg:left-[416px] p-2 bg-[#396BAA4D] backdrop-blur-md w-[184px] h-[104px] text-white">
                    <p className='text-center text-[40px] font-semibold'>300+</p>
                    <p className='text-center text-[16px]'>Happy Clients</p>
                </div>
            </div>
            ...
            <div>
                ...
                <button className='text-[#1B1B1B] w-[220px] h-[67px] rounded-sm text-[20px] font-semibold bg-[#FFA500] mt-4'>Our Story</button>
            </div>
          </div>
        </div>
      </section>
