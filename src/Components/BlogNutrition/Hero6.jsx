  ...
  return (
    <section>
        ...
        <div className='mt-10'>
            ...
            <h2 className='text-[#1B1B1B] lg:text-[32px] font-semibold mt-2'>Nutrition 101: <br /> A Beginner's Guide to Healthy Eating</h2>
            <div className='leading-loose mt-3'>
                <h1 className='flex items-center lg:text-[20px] text-[#514A4A] gap-[3px]'><img src={pentool3} alt=""/>Felicia Tilman</h1>
        ...
        <div className='grid lg:grid-cols-2 lg:-space-x-80 mt-7'>
            <div>
            ...
            <div>
                <h1 className='text-[#1B1B1B] text-[16px] leading-loose'>Embarking on a journey towards healthier eating habits can be both exciting and overwhelming, especially if you're just starting out. <br className='lg:block hidden'/>
                But fear not! Our blog series, "Nutrition 101," is here to guide you through the essentials of healthy eating, providing you <br className='lg:block hidden'/> with the knowledge and tools you need to nourish your body and enhance your well-being.</h1>


                <div className='leading-loose'>
                    <h1 className='lg:text-[24px] text-[20px] font-semibold text-[#1B1B1B]'>Incorporating Whole Foods</h1>
                ...
                <div className='leading-loose'>
                    <h1 className='lg:text-[24px] text-[20px] font-semibold text-[#1B1B1B]'>Choosing Healthy Fats</h1>
                ...
                <div className='leading-loose'>
                    <h1 className='lg:text-[24px] text-[20px] font-semibold text-[#1B1B1B]'>Balancing Macronutrients</h1>
                ...
                <div className='leading-loose'>
                    <h1 className='lg:text-[24px] text-[20px] font-semibold text-[#1B1B1B]'>Hydration and Mindful Eating</h1>
                ...
                <div className='leading-loose mt-3'>
                    <h1 className='lg:text-[24px] text-[20px] font-semibold text-[#1B1B1B]'>Related Blogs:</h1>
